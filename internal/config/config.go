...
func Load() (*Config, error) {
	...
	viper.SetDefault("database.host", "switchyard.proxy.rlwy.net")
	viper.SetDefault("database.port", 19574)
	viper.SetDefault("database.user", "postgres")
	viper.SetDefault("database.password", "qbzXeLNRZJtBEolwmnkmhTvcdINDWIQv")
	viper.SetDefault("database.name", "railway")
